...
import (
	"DistributedFileSystem/common/lib/objectStream"
...
func NewRSResumablePutStreamFromToken(ftoken string) (*RSResumablePutStream, error) {
	/*
		PathEscape的逆转换，将形式为"%AB"的每个3字节编码的子字符串转换为解码后的十六进制字节0xAB
		比如: "my%2Fcool+blog&about%2Cstuff" 转换为 => "my/cool+blog&about,stuff"
	*/
